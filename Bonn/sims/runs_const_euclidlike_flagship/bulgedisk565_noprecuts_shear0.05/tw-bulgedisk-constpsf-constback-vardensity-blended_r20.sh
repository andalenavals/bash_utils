...
WORKDIR=/vol/euclidraid4/data/aanavarroa/catalogs/MomentsML/fullimages_constimg_euclid-flagship0.05/tw-bulgedisk-constpsf-constback-blended-vardensity-big
