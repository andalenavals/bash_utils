...
WORKDIR=/vol/euclidraid4/data/aanavarroa/catalogs/MomentsML/fullimages_constimg_euclid-flagship0.05/vo-bulgedisk-constpsf-constback-blended-vardensity-big
