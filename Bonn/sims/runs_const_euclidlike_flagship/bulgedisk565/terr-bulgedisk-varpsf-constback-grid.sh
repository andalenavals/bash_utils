...
WORKDIR=/vol/euclidraid4/data/aanavarroa/catalogs/MomentsML/fullimages_constimg_euclid-flagship/terr-bulgedisk-varpsf-constback-grid
SIMDIR=$WORKDIR/sim
SEXDIR=$WORKDIR/sex
