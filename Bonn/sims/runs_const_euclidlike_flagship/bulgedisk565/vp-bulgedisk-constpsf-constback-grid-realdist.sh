...
WORKDIR=/vol/euclidraid4/data/aanavarroa/catalogs/MomentsML/fullimages_constimg_euclid-flagship/vp-bulgedisk-constpsf-constback-grid-realdist
SIMDIR=$WORKDIR/sim
SEXDIR=$WORKDIR/sex
